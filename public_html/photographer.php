...
<p>Below is a list of all photographer listed in the database.  To update an existing photography, click on the photographer's name. If you wish to removed a photographer, click on "DELETE" beside that persons name.  To add a new photographer, <a href="add_photographer.php">click here</a>.</p>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
	  	  ...
	  	  <?php do { ?>
	        <tr>
                <td><a href="update_photographer.php?PhotographerID=<?php echo $row_getPosts['PhotographerID']; ?>"><?php echo $row_getPosts['PhotographerName']; ?></a></td>
