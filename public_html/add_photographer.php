...
$insertSQL = sprintf("INSERT INTO tblPhotographer (LastName, PhotographerName, InstitutionAddress) VALUES (%s, %s, %s)",
		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Add Photographer</h1>
                  </header>
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
    ...
    <p>
      ...
      <input name="LastName" type="text" required="required" id="LastName" size="64">
    </p>
    <p>
      <label for="PhotographerName">Photographer's Name:</label>
        <input name="PhotographerName" type="text" id="PhotographerName" size="64">
        <br>
</p>
      <p>
        <label for="InstitutionAddress">Institution/Address:</label>
        <input name="InstitutionAddress" type="text" id="InstitutionAddress" size="64">
        <br>
      </p>
      <p>
      ...
      <p>
        ...
        <input name="insert" type="submit" id="insert" form="form1" value="Add Photographer">
