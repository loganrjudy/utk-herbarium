		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Non-TN Seed Photos</h1>
                  </header>
<p>Below is a list of all seed photos <strong>NOT</strong> found in the state of Tennessee. To search for a specific photo, type in the name of species (any part of the name will work) or the JKU and click search. To add a new photo, <a href="add_nontn_seed_photo.php">click here</a>.</p>
		<form action="nontnseedphotolist.php" method="GET">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <?php if (!empty($row_getPosts['SeedFileName'])) { ?>
                <tr>
                  <td width="100"><IMG class="aligncenter" SRC="vascular/nontnseeds/<?php echo $row_getPosts['SeedFileName']; ?>.jpg" alt="<?php echo $row_getPosts['SeedFileName']; ?>" style="max-height: 100px;"></td>
                  <td><strong>Species:</strong> <?php echo $row_getPosts['Genus']; ?> <?php echo $row_getPosts['Species']; ?><br>
                    ...
                    <strong>Image Name:</strong> <?php echo $row_getPosts['SeedFileName']; ?>.jpg</td>
          ...
          <?php 
				if(mysqli_num_rows($getPosts) >= 50) {
					...
					$rows=mysqli_num_rows(mysqli_query("select * from tblNonTNSeeds"));
