		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Associate Common Name with a Species</h1>
                  </header>
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
    ...
    <p>
      ...
      <select name="CommID" id="CommID">
		...
		?>
		  <?php do { ?>
			<option value="<?php echo $row_getPosts['CommID']; ?>"><?php echo $row_getPosts['CommonName']; ?></option>
		  <?php } while ($row_getPosts = mysqli_fetch_assoc($getPosts))?>
      </select>
  </p>
      <p>
        
        <input name="insert" type="submit" id="insert" form="form1" value="Associate Common Name">
