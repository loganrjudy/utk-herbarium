		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
					...
					<?php		
					$selected_category = $_POST['CategoryName'];
					$selected_family = $_POST['Family'];
					$selected_species_id = $_POST['SpeciesID'];	
					$selected_photographer_id = $_POST['PhotgrapherID'];	
					$creation_date = $_POST['CreationDate'];	
					$image_name =  $_POST['PhotoName'];		
					$seed_image_name =  $_POST['SeedPhotoName'];		
					$seed_jku =  $_POST['JKU'];		
					$seed_orientation =  $_POST['orientation'];	
					...
					$target_dir = "/home/herbariumweb/public_html/vascular/photoD/" . $selected_category . "/" . $selected_family . "/";
