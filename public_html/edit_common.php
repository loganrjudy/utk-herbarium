...
$updateSQL = sprintf("UPDATE tblCommonName SET CommonName=%s WHERE CommID=%s",
				   GetSQLValueString($_POST['CommonName'], "text"),
		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Edit Common Name</h1>
                  </header>
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
    <p>
      <label for="CommonName">Common Name:</label>
      <input name="CommonName" type="text" required="required" id="CommonName" value="<?php echo $row_getPost['CommonName']; ?>" size="64">
  </p>
      <p>
        
        <input name="update" type="submit" id="update" form="form1" value="Update Common Name">
		<input name="CommID" type="hidden" id="CommID" value="<?php echo $row_getPost['CommID']; ?>">
