...
$updateSQL = sprintf("UPDATE tblPhotographer SET LastName=%s, PhotographerName=%s, InstitutionAddress=%s, Email=%s WHERE PhotographerID=%s",
				   GetSQLValueString($_POST['LastName'], "text"),
				   GetSQLValueString($_POST['PhotographerName'], "text"),
				   GetSQLValueString($_POST['InstitutionAddress'], "text"),
				   GetSQLValueString($_POST['Email'], "text"),
				   GetSQLValueString($_POST['PhotographerID'], "int"));
...
if (isset($_GET['PhotographerID'])) {
  $colname_getPost = $_GET['PhotographerID'];
}
		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Update Photographer</h1>
                  </header>
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
    ...
    <p>
      ...
      <input name="LastName" type="text" required="required" id="LastName" value="<?php echo $row_getPost['LastName']; ?>" size="64">
    </p>
    <p>
      <label for="PhotographerName">Photographer's Name:</label>
        <input name="PhotographerName" type="text" id="PhotographerName" value="<?php echo $row_getPost['PhotographerName']; ?>" size="64">
        <br>
</p>
      <p>
        <label for="InstitutionAddress">Institution/Address:</label>
        <input name="InstitutionAddress" type="text" id="InstitutionAddress" value="<?php echo $row_getPost['InstitutionAddress']; ?>" size="64">
        <br>
      </p>
      <p>
        <label for="Email">Email:</label>
        <input name="Email" type="text" id="Email" value="<?php echo $row_getPost['Email']; ?>" size="64">
        <br>
      </p>
      <p>
        
        <input type="submit" name="update" id="update" value="Update Photographer">
			    <input name="PhotographerID" type="hidden" id="PhotographerID" value="<?php echo $row_getPost['PhotographerID']; ?>">
