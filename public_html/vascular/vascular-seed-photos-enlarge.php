...
$varGenus = $_GET["GenusID"];
$varSpecies = $_GET["SpeciesID"];
$varPhotoName = $_GET["PhotoNameID"];
		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header"><h1 class="entry-title">Vascular Plant Herbarium</h1>
								  ...
								  <h3><strong>Non TN Seed Photos</strong></h3>
									<p><strong><?php echo $varGenus; ?> <?php echo $varSpecies; ?></strong></p>
									<p><IMG class="aligncenter" SRC="nontnseeds/<?php echo $varPhotoName; ?>.jpg" alt="<?php echo $varPhotoName; ?>" /></p>
								  <br clear="all" />
								  <div>
