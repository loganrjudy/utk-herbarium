                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header"><h1 class="entry-title">Vascular Plant Herbarium</h1>
						          ...
						          <strong>Family Name:</strong> <?php echo $row_getPost['FamilyName']; ?></p>
									...
									<?php do {
											if ($row_getPost['GenusName'] != $GenusLast) {?>
												<p><strong><?php echo $row_getPost['GenusName']; ?></strong> - [<a href="vascular-maps.php?CategoryID=<?php echo $row_getPost['CategoryName']; ?>&FamilyID=<?php echo $row_getPost['FamilyName']; ?>&GenusID=<?php echo $row_getPost['GenusName']; ?>">maps</a> | <a href="vascular-photos.php?CategoryID=<?php echo $row_getPost['CategoryName']; ?>&FamilyID=<?php echo $row_getPost['FamilyName']; ?>&GenusID=<?php echo $row_getPost['GenusName']; ?>">photos</a>]</p>
											<?php } $GenusLast = $row_getPost['GenusName']; 
