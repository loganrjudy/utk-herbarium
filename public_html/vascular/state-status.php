...
$query_getPosts = "SELECT * FROM tblStateStatus WHERE StateStatusID != 'N/A' ORDER BY StateStatus ASC";
		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header"><h1 class="entry-title">Vascular Plant Herbarium</h1>
								  ...
								  <h3>State Status</h3>
									  <?php do { ?>
										<h4><a href="vascular-search-status-results.php?StateStatusID=<?php echo $row_getPosts['StateStatus']; ?>"><?php echo $row_getPosts['StateStatus']; ?></a></h4>
