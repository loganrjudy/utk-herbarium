		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Genus and Author</h1>
                  </header>
<p>Below is a list of all genera. To search for a specific genus, type in the name of the genus, author or common name and click search. To add a new genus, <a href="add_genus.php">click here</a>.</p>
		<form action="genuslist.php" method="GET">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th>Genus Name</th>
            <th>Genus Author</th>
            <th>Genus Common Name</th>
            <th width="60">&nbsp;</th>
          </tr>
	  	  <?php do { ?>
	        <tr>
	          <td><?php echo $row_getPosts['GenusName']; ?></td>
			  <td><?php echo $row_getPosts['G_Author']; ?></td>
			  <td><?php echo $row_getPosts['G_CommName']; ?></td>
			  <td width="60" style="text-align:center;"><a class="btn btn-smokey btn-block" href="delete_genus.php?GenusID=<?php echo $row_getPosts['GenusID']; ?>">DELETE</a></td>
            </tr>
          ...
          <?php 
				if(mysqli_num_rows($getPosts) >= 50) {
					...
					$rows=mysqli_num_rows(mysqli_query("select * from tblGenus"));
