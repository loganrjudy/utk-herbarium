		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Upload Non-TN Seed Photo</h1>
                  </header>
<form enctype="multipart/form-data" action="upload_seed_photo.php" method="POST">
	<p>
	  <label for="Genus">Genus:</label>
     	 <input name="Genus" type="text" id="Genus" size="64">
	</p>
	<p>
	  <label for="Species">Species:</label>
     	 <input name="Species" type="text" id="Species" size="64">
	</p>
      <p>
      ...
      <p>
        <label for="SeedFileName">Seed Photo Name:</label>
     	 <input name="SeedFileName" type="text" id="SeedFileName" size="64"> 
