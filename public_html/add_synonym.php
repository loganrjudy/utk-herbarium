		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Add Synonym</h1>
                  </header>
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
    <p>
      <label for="Synonym">Synonym:</label>
      <input name="Synonym" type="text" required="required" id="Synonym" size="64">
  </p>
      <p>
        
        <input name="insert" type="submit" id="insert" form="form1" value="Add Synonym">
...
$insertSQL1 = "INSERT INTO tblSynonym (Synonym) VALUES ('".mysqli_real_escape_string($synonym)."')";
	...
	if (mysql_query($insertSQL1, $Herbarium)) {
		...
		echo "<h4>Sorry, there was an error adding the synonym.</h4>";
	}
