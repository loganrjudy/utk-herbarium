		...
		<div id="content" class="site-content site-content wide" role="main">
                ...
                <!-- And here begins the Content area. This is where you place your content -->
                  ...
                  <header class="entry-header">
                    <h1 class="entry-title">Common Name</h1>
                  </header>
<p>Below is a list of all common names. To search for a specific common name, enter the common name and click search. To add a new common name, <a href="add_common.php">click here</a>.</p>
		<form action="commonlist.php" method="GET">
		...
		<?php 
			...
			$query_getPosts = "SELECT * FROM tblCommonName WHERE (CommonName LIKE '%$query%') ORDER BY CommonName ASC LIMIT $start, $limit";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
	  	  ...
	  	  <?php do { ?>
	        <tr>
                <td><a href="edit_common.php?CommID=<?php echo $row_getPosts['CommID']; ?>"><?php echo $row_getPosts['CommonName']; ?></a></td>
			  <td width="60" style="text-align:center;"><a class="btn btn-smokey btn-block" href="delete_common.php?CommID=<?php echo $row_getPosts['CommID']; ?>">DELETE</a></td>
            </tr>
          ...
          <?php 
				if(mysqli_num_rows($getPosts) >= 100) {
					$rows=mysqli_num_rows(mysqli_query("select * from tblCommonName"));
