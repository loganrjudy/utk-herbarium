...
<p>To search for a specific photo, type in the name of the photo (actual file name) and click search. To add a new photo, <a href="add_photo.php">click here</a>.</p>
		<form action="photolist.php" method="GET">
		...
		<?php 
			...
			WHERE tblPhoto.PhotoName LIKE '%$query%'
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            ?>
	        <tr>
	          <td><IMG class="aligncenter" SRC="vascular/photoD/<?php echo $row_getPosts['CategoryName']; ?>/<?php echo $row_getPosts['FamilyName'];; ?>/<?php echo $row_getPosts['PhotoName']; ?>.jpg" alt="<?php echo $row_getPosts['PhotoName']; ?>" style="max-height: 100px;"></td>
